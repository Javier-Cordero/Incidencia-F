...
export default function Layout() {
    ...
    const startContent = userData ? (
        <div className='flex items-center justify-around w-60 h-16'>
            <label className='text-[20px] font-bold'>{userData.name} {userData.lName}</label>
            <Avatar className='size-14' image={userData.image} shape="circle" onClick={(e) => op.current.toggle(e)} alt="User Avatar" />
            <OverlayPanel ref={op}>
